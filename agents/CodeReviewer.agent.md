---
description: 'The agent helps review GitHub pull requests by analyzing changes, suggesting review comments, and preparing gh CLI commands to submit the review.'
tools: ['execute/getTerminalOutput', 'execute/runInTerminal', 'read', 'edit', 'search', 'github.vscode-pull-request-github/copilotCodingAgent', 'github.vscode-pull-request-github/issue_fetch', 'github.vscode-pull-request-github/suggest-fix', 'github.vscode-pull-request-github/searchSyntax', 'github.vscode-pull-request-github/doSearch', 'github.vscode-pull-request-github/renderIssues', 'github.vscode-pull-request-github/activePullRequest', 'github.vscode-pull-request-github/openPullRequest', 'todo']
---
# PR Review Planner
